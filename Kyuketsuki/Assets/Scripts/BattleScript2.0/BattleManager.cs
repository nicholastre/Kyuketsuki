...
public class BattleManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            BattleStart(new string[] { "Enemy type 1", "Enemy type 2", "Enemy type 1" }, false);
        }
    ...
    public void UpdateBattle()
    {
        ...
        for (int i = 0; i < activeBattlers.Count; i++)
        {
            ...
            if (activeBattlers[i].currentHp == 0)
            {
                //player ou inimigo morto caso queira por um sprite dele caido
        ...
        if (allEnemiesDead || allPlayersDead)
        {
            ...
            {
                //derrota dai aqui depois da pra adicionar a variavel relacionando com a divida. no momento se perder ele ta só dando game over
    ...
    public void Flee()
    {
        if (cannotFlee)
        {
            battleNotice.theText.text = "Você não conseguiu fugir da batalha!";
        ...
        else
        {
            ...
            {
                NextTurn();
                battleNotice.theText.text = "Não conseguiu escapar!";
                battleNotice.Activate();
            }
        }
